  ...
  return (
    <div className="prometheus-auth-fx" aria-hidden="true">
      {stars.map((star) => (
        <span
          key={`star-${star.id}`}
          className="prometheus-auth-star"
          style={{
            width: `${star.size}px`,
            height: `${star.size}px`,
            top: `${star.top}%`,
      ...
      {orbs.map((orb) => (
        <span
          ...
          style={{
            ...
            background: orb.purple ? "var(--prometheus-auth-purple)" : "var(--prometheus-auth-blue)",
          }}
        />
      ))}
      {particles.map((particle) => (
        <span
          ...
          className="prometheus-auth-particle"
          style={{
      ...
      <main className="prometheus-auth-main">
        <section className="prometheus-auth-panel">
          <div className="prometheus-auth-intro">
            ...
            <p>Sign in to access your neural assistant and survival tasks.</p>
          </div>

          <div className="prometheus-auth-card">
            <div className="prometheus-auth-card-glow" />
            <form className="prometheus-auth-form" onSubmit={handleLogin}>
              <div>
              ...
              <div>
                <div className="prometheus-auth-label-row">
          ...
          <p className="prometheus-auth-switch">
            New to Prometheus? <a href="/signup">Create an account</a>
          </p>
        </section>
      </main>
